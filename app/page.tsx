...
export default function Home() {
  ...
  return (
    <>
      ...
      <section
        id="about"
        className="relative border-t border-white/10 bg-gradient-to-b from-obsidian via-graphite to-graphite py-20 text-mist"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_10%,rgba(56,189,248,0.18),transparent_65%),radial-gradient(circle_at 80%_0%,rgba(99,102,241,0.15),transparent_55%)] opacity-70" />
        <div className="relative mx-auto max-w-4xl space-y-7 px-6 text-center md:px-12">
          <p className="text-xs uppercase tracking-[0.6em] text-mist/60">
            About
          </p>
